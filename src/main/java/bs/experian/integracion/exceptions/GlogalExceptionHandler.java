package bs.experian.integracion.exceptions;
...
public class GlogalExceptionHandler {
	// ===== ERRORES DESERIALIZACIÓN REQUEST =====
	    ...
	    public ResponseEntity<ErrorResponse> handleValidation(
	        ...
	        log.warn("ERR INTEGRACION-EXPERIAN validación input path={} msg={}", request.getRequestURI(), "error de validacion");
	    ...
	    public ResponseEntity<ErrorResponse> handleBusiness(
	        ...
	        log.error("ERR INTEGRACION-EXPERIAN downstream status={} path={} msg={} body={}",
		...
		public ResponseEntity<ErrorResponse> handleCommunicationErrors(
		    ...
		    log.error("ERR INTEGRACION-EXPERIAN comunicación caida", ex);
	    ...
	    public ResponseEntity<ErrorResponse> handleGeneric(
	        ...
	        ErrorResponse error = new ErrorResponse(
	                ...
	                "error interno del servicio INTEGRACION-EXPERIAN",
	                "error generico",
	                request.getRequestURI(),
	                LocalDateTime.now()
	        );

	        log.error("ERR INTEGRACION-EXPERIAN interno", ex);
	    ...
	    public ResponseEntity<ErrorResponse> handleDatabaseError(
	        ...
	        log.error("ERR BDD INTEGRACION-EXPERIAN path={}", request.getRequestURI(), ex);
